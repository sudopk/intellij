...
public class AswbRenderTaskTest extends BlazeAndroidIntegrationTestCase {
  ...
  public void testLayoutReferenceResourceFromSameModule() throws Exception {
    ...
    withRenderTask(resourceModule, layoutXml, task -> checkRenderResult(task.render()));
  }
  ...
  private static void withRenderTask(Module module, VirtualFile file, Consumer<RenderTask> consumer)
      throws Exception {
   ...
   */
  private static void checkRenderResult(CompletableFuture<RenderResult> futureResult) {
